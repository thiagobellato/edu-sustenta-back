...
class User(AbstractUser):
    ROLE_CHOICES = (('ALUNO', 'Aluno'), ('PROFESSOR', 'Professor'), ('GESTOR', 'Gestor'))
...
class School(models.Model):
    ...
    # [NOVO] O Gestor dono da escola
    manager = models.ForeignKey(User, on_delete=models.CASCADE, related_name='managed_schools', null=True, blank=True)
...
# [NOVO] Modelo de Notificação (O front já espera isso!)
